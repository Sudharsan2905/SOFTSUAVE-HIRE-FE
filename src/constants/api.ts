...
export const API_ENDPOINTS = {
  ...
  CANDIDATE: {
    ...
    ASSESSMENT_START: (shareLink: string) =>
      `${API_BASE_PATH}/candidate/assessment/${shareLink}/start`,
    ...
    SUBMISSION_FINISH_ROUND: (id: string) =>
      `${API_BASE_PATH}/candidate/submission/${id}/finish-round`,
    SUBMISSION_SCREENSHOT: (id: string) => `${API_BASE_PATH}/candidate/submission/${id}/screenshot`,
    SUBMISSION_MALPRACTICE: (id: string) =>
      `${API_BASE_PATH}/candidate/submission/${id}/malpractice`,
